...
$email   = $_GET["email"];
$mensaje_contacto = '<a href="http://www.nfnempresas.com/nfn.apk">Presiona aquí para descargar la APP</a>';

$asunto  = 'Envío de Aplicación BETA NFN';

$casilla = "$email";

$cabeceras = "From: soporte@nfn.cl\r\n";
