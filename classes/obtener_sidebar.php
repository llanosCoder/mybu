    ...
    protected function procesar(){
        ...
        <li><a href="javascript:void(0);"><i class="fa fa-nfn fa-shopping-cart"></i><span>Ventas</span></a>
                    <ul class="sub-menu">
                        ...
                        <li><a href="anular_venta.html" style="color:red;">Anular Venta</a></li>
                        <hr style="margin: 5px;">
                        <li><a href="cierre_caja.html">Cierre de Caja</a></li>
                    </ul>
                </li>
                
                <li onclick="location.href='stock.html';"><a href="stock.html"><i class="fa fa-nfn fa-list-ol"></i><span>Stock</span></a>
                    <ul class="sub-menu">
                        <li class="dropdown-header" onclick="location.href='stock.html';"><i class="fa fa-nfn fa-list-ol"></i><span>Stock</span></li>
                    </ul>
                </li>
                <li onclick="location.href='registrar_gasto.html';"><a href="registrar_gasto.html"><i class="fa fa-nfn fa-usd"></i><span>Gastos</span></a>
                    <ul class="sub-menu">
                        <li class="dropdown-header" onclick="location.href='registrar_gasto.html';"><i class="fa fa-nfn fa-list-ol"></i><span>Gastos</span></li>
                    </ul>
                </li>
        <?php
        ...
        switch($this->rol){
            ...
            <!--li id="administracion">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="inventario_promociones.html">Promociones</a>
                    </li>
                    <li><a href="formulario_empresa.html">Usuario</a>
                    </li>
                    <li><a href="admin_importacion.html">Importar productos</a>
