...
class Categorias{
    ...
    function obtener_categorias($cat_padre, &$jerarquia = 1){
        $consulta = "SELECT categoria_id as cid, categoria_nombre as nombre, categoria_descripcion as descripcion, categoria_padre as padre FROM categoria WHERE categoria_padre = $cat_padre AND categoria_id != 0";
