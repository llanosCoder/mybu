...
function changeSize(text,total,place){
...
function printESCP(objeto) {
    ...
    window["qzDoneAppending"] = function() {
        ...
        $.each(objeto, function (i, p) {
            ...
            var precio =  changeSize(p.producto_precio,7,'b');
        ...
        qz.append("Cantidad      Codigo            Precio    %     Valor\r\n");
        //LIKE Table Rows
        qz.append("       1      00002             15200     0     15200\r\n");
        qz.append("       3      00001             15200     0     15200\r\n");
        qz.append("       2      00002             15200     0     15200\r\n");
        qz.append("       4      00003             15200     0     15200\r\n");
