var productosCodigo = [], productosCantidad = [], productosStock = [], productosMinimo = [], indiceOrden = 1;
    ...
    $.post(url, {
        ...
        $("#tabla_ordenes").dataTable({
            ...
            "oLanguage": {
                ...
                "sZeroRecords": "No se encontraron ordenes de compra vencidas",
                "sEmptyTable": "No hay ordenes de compra vencidas",
...
function obtenerProductosOrden(voucher, total) {
    ...
    $.post(url, {
        ...
        $("#btn_autorizar_modal").bind("click", function () {
            autorizarCompra(voucher, total);
        });
        $("#btn_rechazar_modal").bind("click", function () {
            rechazarCompra(voucher);
        });
    });
}