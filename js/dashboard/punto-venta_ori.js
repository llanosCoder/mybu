$(document).ready(function () {
    ...
    $("#btn-finalizar-compra").click(function () {
        ...
        $("#pagar-body").html('<div class="text-center"> <div class="i-circle success"> <i class="fa fa-spinner fa-spin"> </i> </div><h4> Procesando... </h4></div>');
        var venta_JSON = {
            set_venta: 1,
            venta_bruto: bruto,
    ...
    function venta_divs() {
        $("#pagar-body").html('<div class="text-center"> <div class="i-circle success"> <i class="fa fa-check"> </i> </div> <h4> ¡Realizado con éxito! </h4> <p> La venta ha sido completada, </p> </div>');
