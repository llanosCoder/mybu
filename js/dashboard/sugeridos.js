    ...
    $.post("classes/obtener_categorias.php",
        ...
        function(data){
            ...
            $.each(data, function(i, datos) {
                ...
                treeCategorias += '<li><label class="tree-toggler nav-header" onClick="cargarMarcas(\''+datos.desc+'\');" id="'+datos.desc+'"><i class="fa fa-folder-o icon-tree"></i>'+datos.nombre+'<i class="fa fa-plus-circle agregar_marca"  data-modal="form-agregar-marca" onClick="setMarca(\''+datos.desc+'\');"></i></label>';
