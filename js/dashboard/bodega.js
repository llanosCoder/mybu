...
function cargarProductos() {
    ...
    $.post("classes/obtener_productos.php", {
        ...
        function (data) {
            ...
            table += '<th>Descripción</th><th>Precio Unit.</th><th>Precio Mayor.</th><th>Costo compra</th><th>Stock real</th><th>Stock mín.</th>';
...
function guardarModal() {
    ...
    datos['stock_r'] = sanear_numero($("#stock_r").val());
