...
$('#refrescar').on('click', function () {
    if ($.isArray(categoriaMarcaNueva)) {
        cargarMarcas(categoriaMarcaNueva[0]);
    } else {
        cargarMarcas(categoriaMarcaNueva);
    }
...
$('#agregar_marca_sin_categoria').click(function() {
    ...
    pag0 += '<select id="select_categorias" name="select_categorias" class="select2 form-control pag-1 required"></select>';
    pag0 += '</div>';
