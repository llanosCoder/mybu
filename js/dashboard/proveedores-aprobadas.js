...
$(document).ready(function documentoListo() {
    obtenerOrdenesAprobadas(indiceOrden);
});
...
function obtenerOrdenesAprobadas(orden) {
    ...
    $.post(url, {
        ...
        $("#tabla_ordenes").dataTable({
            ...
            "oLanguage": {
                ...
                "sZeroRecords": "No se encontraron ordenes de compra aprobadas",
                "sEmptyTable": "No hay ordenes de compra aprobadas",
