$(document).ready(function(){
    $("#tabla_proveedores_productos").DataTable();
    ...
    $.post("classes/obtener_categorias.php",
        ...
        function(data){
            ...
            $.each(data, function(i, datos) {
                ...
                treeCategorias += '<li><label class="tree-toggler nav-header" onClick="cargarProductos(\''+datos.desc+'\');" id="'+datos.desc+'"><i class="fa fa-folder-o icon-tree"></i>'+datos.nombre+'</label>';
        ...
        $('#btn_carro').modalEffects();
        $("#tabla_carro_compra").DataTable({
            bFilter: false,
            bLengthChange : false
        });
